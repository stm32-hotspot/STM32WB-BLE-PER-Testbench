...
typedef enum
{
    ...
    CFG_TASK_PER_TEST_CONFIG_ID,          
    CFG_TASK_PER_TEST_START_TX_ID,        
    CFG_TASK_PER_TEST_START_RX_ID,     
    CFG_TASK_PER_TEST_STOP_TX_ID,         
    CFG_TASK_PER_TEST_STOP_RX_ID,         
    CFG_TASK_PER_TEST_MEASURE_PER_ID,    
    CFG_TASK_ADV_CONFIG_ID,                  
